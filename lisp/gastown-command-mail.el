...
(gastown-defcommand gastown-command-mail-inbox (gastown-command-global-options)
  ((all
    ...
    :option-type :boolean
    :key "a"
    :transient-description "Show all messages including read"
   ...
   (unread
    ...
    :option-type :boolean
    :key "u"
    :transient-description "Show only unread messages"
    :class transient-switch
    :argument "--unread"
...
(gastown-defcommand gastown-command-mail-send (gastown-command-global-options)
  ((recipient
    ...
    :option-type :string
    :key "r"
    :transient-description "Recipient (required)"
    :class transient-option
   ...
   (subject
    ...
    :option-type :string
    :key "s"
    :transient-description "Mail subject"
    :class transient-option
    :argument "--subject="
    :prompt "Subject: "
    :transient-group "Required"
   ...
   (message-body
    ...
    :option-type :string
    :key "m"
    :transient-description "Message body"
    :class transient-option
    :argument "-m="
    :prompt "Message: "
...
(gastown-defcommand gastown-command-mail-archive (gastown-command-global-options)
  ((mail-ids
    ...
    :option-type :string
    :key "i"
    :transient-description "Message ID(s)"
    :class transient-option
    :prompt "Message IDs: "
    :transient-group "Options"
    :level 1
...
(gastown-defcommand gastown-command-mail-claim (gastown-command-global-options)
  ((queue-name
    ...
    :option-type :string
    :key "q"
    :transient-description "Queue name"
    :class transient-option
    :prompt "Queue name: "
    :transient-group "Options"
    :level 1
...
(gastown-defcommand gastown-command-mail-clear (gastown-command-global-options)
  ((target
    ...
    :option-type :string
    :key "t"
    :transient-description "Target (optional)"
    :class transient-option
    :prompt "Target: "
    :transient-reader gastown-reader-mail-address
    :transient-group "Options"
...
(gastown-defcommand gastown-command-mail-delete (gastown-command-global-options)
  ((mail-ids
    ...
    :option-type :string
    :key "i"
    :transient-description "Message ID(s) (required)"
    :class transient-option
    :prompt "Message IDs: "
    :transient-group "Required"
    :level 1
...
(gastown-defcommand gastown-command-mail-release (gastown-command-global-options)
  ((mail-id
    ...
    :option-type :string
    :key "i"
    :transient-description "Message ID (required)"
    :class transient-option
    :prompt "Message ID: "
    :transient-group "Required"
    :level 1
...
(gastown-defcommand gastown-command-mail-reply (gastown-command-global-options)
  ((mail-id
   ...
   (subject
    ...
    :option-type :string
    :key "s"
    :transient-description "Subject override"
    :class transient-option
    :argument "--subject="
    :prompt "Subject: "
    :transient-group "Options"
...
(gastown-defcommand gastown-command-mail-search (gastown-command-global-options)
  ((query
    ...
    :option-type :string
    :key "q"
    :transient-description "Query (required)"
    :class transient-option
    :prompt "Query: "
    :transient-group "Required"
    :level 1
...
(gastown-defcommand gastown-command-mail-thread (gastown-command-global-options)
  ((thread-id
    ...
    :option-type :string
    :key "t"
    :transient-description "Thread ID (required)"
    :class transient-option
    :prompt "Thread ID: "
    :transient-group "Required"
    :level 1
